...
<body>
    ...
    <section class="position-relative pb-5 section-hero"
		...
		<div class="container">
			<div class="col-12 mx-auto">
				...
				<h1 class="my-5"
					...
					Gana experiencia real y <br>amplía tus oportunidades
				</h1>
				...
				<p class="py-2 mb-4"
				   style="font-size: clamp(1rem, 2.5vw, 1.4rem); line-height: 1.6; max-width: 90%; margin: 0 auto; color: #555;">
				...
				<p class="py-2 mb-4"
				   style="font-size: clamp(1.1rem, 3vw, 1.6rem); font-weight: 700; max-width: 90%; margin: 0 auto; color: #555;">
